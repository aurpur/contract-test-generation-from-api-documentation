...
class TestMessageBuilder:
    ...
    def test_build_basic_message(self):
        ...
        message = (
            ...
            .with_type(MessageType.TEST_REQUEST)
...
class TestMessageRouter:
    ...
    async def test_register_and_route_message(self):
        ...
        router.register_handler(MessageType.TEST_REQUEST, handler)
    ...
    async def test_handler_exception(self):
        ...
        router.register_handler(MessageType.TEST_REQUEST, failing_handler)
...
class TestEventBus:
    ...
    async def test_multiple_subscribers(self):
        ...
        async def subscriber_1(data: dict):
            received_1.append(data)
        
        async def subscriber_2(data: dict):
    ...
    async def test_unsubscribe(self):
        ...
        bus.subscribe(EventType.WORKFLOW_STARTED, subscriber)
        await bus.publish(EventType.WORKFLOW_STARTED, {"iteration": 1})
        
        await asyncio.sleep(0.1)
        
        bus.unsubscribe(EventType.WORKFLOW_STARTED, subscriber)
        await bus.publish(EventType.WORKFLOW_STARTED, {"iteration": 2})
    ...
    async def test_subscriber_exception(self):
        ...
        async def failing_subscriber(data: dict):
            raise ValueError("Subscriber error")
        
        async def good_subscriber(data: dict):
            received_good.append(data)
        
        bus.subscribe(EventType.SYSTEM_ERROR, failing_subscriber)
        bus.subscribe(EventType.SYSTEM_ERROR, good_subscriber)
        
        await bus.publish(EventType.SYSTEM_ERROR, {"error": "test"})
...
class TestPickleSerializer:
    ...
    def test_serialize_deserialize(self):
        ...
        message = (
            ...
            .with_type(MessageType.TEST_READY)
            .for_session(uuid4())
