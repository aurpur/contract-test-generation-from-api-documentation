...
def sample_bruno_request():
    ...
    from parsers.bruno_models import BrunoBody, BrunoAuth, BrunoScript
...
def sample_parse_result(sample_bruno_request):
    ...
    from parsers.bruno_models import BrunoConfig
...
class TestEndpointExtraction:
    ...
    def test_extract_headers(self, inductor_agent):
        ...
        from parsers.bruno_models import BrunoHeader, BrunoBody, BrunoAuth, BrunoScript
    ...
    def test_extract_query_params(self, inductor_agent):
        ...
        from parsers.bruno_models import BrunoParam, BrunoBody, BrunoAuth, BrunoScript
    ...
    def test_extract_json_body(self, inductor_agent):
        ...
        request = BrunoRequest(
            ...
            headers=[],
            params=[],
            body=BrunoBody(mode="json", json=json_module.dumps(json_body)),
            auth=BrunoAuth(),
            script=BrunoScript(),
        )
...
class TestAuthentication:
    ...
    def test_extract_basic_auth(self, inductor_agent):
        ...
        from parsers.bruno_models import BrunoAuth, BrunoBody, BrunoScript
...
class TestDocumentationCompleteness:
    ...
    def test_completeness_minimal(self, inductor_agent):
        """Test completeness score with minimal documentation."""
        from parsers.bruno_models import BrunoBody, BrunoAuth, BrunoScript
    ...
    def test_completeness_full(self, inductor_agent):
        ...
        request = BrunoRequest(
            ...
            params=[],
            body=BrunoBody(mode="json", json=json_module.dumps({"name": "test"})),
            auth=BrunoAuth(mode="basic", username="user", password="pass"),
            script=BrunoScript(req="console.log('test');", res="pm.test('test', () => {});"),
        )
...
class TestTaskProcessing:
    ...
    async def test_process_parse_collection_task(self, inductor_agent, tmp_path):
        ...
        task = Task(
            ...
            session_id=uuid4(),
            priority=TaskPriority.NORMAL,
            payload={"collection_path": str(collection_file)}
        )
